...
public inline fun createUserRequest(block: user.CreateUserRequestKt.Dsl.() -> kotlin.Unit): user.Create.CreateUserRequest =
  user.CreateUserRequestKt.Dsl._create(user.Create.CreateUserRequest.newBuilder()).apply { block() }._build()
public object CreateUserRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: user.Create.CreateUserRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: user.Create.CreateUserRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): user.Create.CreateUserRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun user.Create.CreateUserRequest.copy(block: user.CreateUserRequestKt.Dsl.() -> kotlin.Unit): user.Create.CreateUserRequest =
  user.CreateUserRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
